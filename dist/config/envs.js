...
exports.DB_USER = process.env.DB_USER || "rodemayo_m4-back-gio-user";
exports.DB_PASSWORD = process.env.DB_PASSWORD || "m4-back-gio-P4ssWord@";
exports.DB_HOST = process.env.DB_HOST || "rodemayo_m4-back-gio";
